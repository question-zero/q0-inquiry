---
title: 'Evidence: claude-fable-5-1.stdout.json'
date: '2026-09-24'
...
source_sha256: c7b36b38dbf9a50838cd58783025825ade7cda88c6cf8b716878597c636776f5
output_sha256: a90b6ab49cbd07c3eb176b6ebb4e99ca4b9d8cf9a5681a1d6850b69b93d71e48
redactions: none
withheld:
  'withheld: Grok quotation (rights check, D1)': 8
lifecycle: active
---

Exported payload `rounds/01-deliberation/evidence/claude-fable-5-1/claude-fable-5-1.stdout.json`. Redactions are marked `[REDACTED: <category>]` and withheld parts `[WITHHELD: <class or category>; see manifest]`. See `sessions/manifest.md`.
