---
title: 'Evidence: claude-fable-5-1.preflight.json'
date: '2026-09-24'
...
source_sha256: 9354f51cece2cb70f3dbc514645d9a817e4e3b70df70c36bdfe1dce60be81b2e
output_sha256: 41618316b9493bbebf739e1c23be5a9485382722e167960f5e4ed10718a6d5d8
redactions: none
withheld: none
lifecycle: active
---

Exported payload `rounds/01-deliberation/evidence/claude-fable-5-1/claude-fable-5-1.preflight.json`. Redactions are marked `[REDACTED: <category>]` and withheld parts `[WITHHELD: <class or category>; see manifest]`. See `sessions/manifest.md`.
