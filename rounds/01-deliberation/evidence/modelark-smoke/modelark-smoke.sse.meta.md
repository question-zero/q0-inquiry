---
title: 'Evidence: modelark-smoke.sse'
date: '2026-09-24'
...
source_sha256: a1e8274499a07f45498c7619d978a7a19d17434f2729cac961100f5b4bc4b30f
output_sha256: 5bd986cb966ea3a1807da701c20419366c4ad8d51fc9aec4eec9ecbdb2b8efea
redactions: none
withheld:
  B, reasoning_content: 58
  'structural: SSE re-serialized, one data line per event': 1
lifecycle: active
---

Exported payload `rounds/01-deliberation/evidence/modelark-smoke/modelark-smoke.sse`. Redactions are marked `[REDACTED: <category>]` and withheld parts `[WITHHELD: <class or category>; see manifest]`. See `sessions/manifest.md`.
