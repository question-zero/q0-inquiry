...
source_sha256: d8db8169acb9fbdf56493a291e4fc7e35f81a79e3febb78794c4205a62b82d98
output_sha256: 9764024f5ec6b05d74051f9c66f735b076d4f4b33e659d080a46cc9836216434
redactions:
  account-id: 2
withheld:
  B, thinking: 1
  'withheld: Grok quotation (rights check, D1)': 13
lifecycle: active
---

Exported payload `rounds/01-deliberation/evidence/deepseek-v4-pro/deepseek-v4-pro.result.json`. Redactions are marked `[REDACTED: <category>]` and withheld parts `[WITHHELD: <class or category>; see manifest]`. See `sessions/manifest.md`.
