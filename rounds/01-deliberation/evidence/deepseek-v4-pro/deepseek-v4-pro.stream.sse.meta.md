...
source_sha256: 2d845da443a65f7dba9bf4f0718b531f8f35d70e3fa57a4d2798fe5553ffc761
output_sha256: b5578deec8460ed198d21934340e1e9b39c4c48c07212ee8ba9b3485d501d083
redactions:
  account-id: 13939
withheld:
  B, reasoning_content: 9360
  'structural: SSE re-serialized, one data line per event': 1
lifecycle: active
---

Exported payload `rounds/01-deliberation/evidence/deepseek-v4-pro/deepseek-v4-pro.stream.sse`. Redactions are marked `[REDACTED: <category>]` and withheld parts `[WITHHELD: <class or category>; see manifest]`. See `sessions/manifest.md`.
