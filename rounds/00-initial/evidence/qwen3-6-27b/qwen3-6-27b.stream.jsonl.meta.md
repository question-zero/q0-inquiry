...
Exported payload `rounds/00-initial/evidence/qwen3-6-27b/qwen3-6-27b.stream.jsonl`. Redactions are marked `[REDACTED: <category>]` and withheld parts `[WITHHELD: <class or category>; see manifest]`. See `sessions/manifest.md`.
