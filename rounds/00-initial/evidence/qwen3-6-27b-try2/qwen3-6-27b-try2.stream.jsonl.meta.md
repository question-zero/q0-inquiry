---
title: 'Evidence: qwen3-6-27b-try2.stream.jsonl'
date: '2026-09-24'
...
Exported payload `rounds/00-initial/evidence/qwen3-6-27b-try2/qwen3-6-27b-try2.stream.jsonl`. Redactions are marked `[REDACTED: <category>]` and withheld parts `[WITHHELD: <class or category>; see manifest]`. See `sessions/manifest.md`.
