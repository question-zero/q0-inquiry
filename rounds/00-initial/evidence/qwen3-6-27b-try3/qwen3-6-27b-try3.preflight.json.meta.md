---
title: 'Evidence: qwen3-6-27b-try3.preflight.json'
date: '2026-09-24'
...
source_sha256: 7940be03f8891b7cc7d60d85676e8d594fad316ce8611a9077073b320453dcdf
output_sha256: c0fb7a96573eaf3e2b305e9e8ffc2132102a9e88b3042a4c45d1a26ffbe05dc3
redactions: none
withheld:
  B, thinking: 1
lifecycle: active
...
Exported payload `rounds/00-initial/evidence/qwen3-6-27b-try3/qwen3-6-27b-try3.preflight.json`. Redactions are marked `[REDACTED: <category>]` and withheld parts `[WITHHELD: <class or category>; see manifest]`. See `sessions/manifest.md`.
