---
title: 'Evidence: deepseek-v4-pro.stream.sse'
date: '2026-09-24'
...
source_sha256: f01c08fa3137cfd26090f2bc86cfc79f9bfaf04386a4e2054d98fc7a3462bdc0
output_sha256: 58c04552f9957346faefc39809286a44abf63d85b44c1cfbb1df096175f4cbfb
redactions:
  account-id: 15012
withheld:
  B, reasoning_content: 12598
  'structural: SSE re-serialized, one data line per event': 1
lifecycle: active
---

Exported payload `rounds/02-deliberation/evidence/deepseek-v4-pro/deepseek-v4-pro.stream.sse`. Redactions are marked `[REDACTED: <category>]` and withheld parts `[WITHHELD: <class or category>; see manifest]`. See `sessions/manifest.md`.
