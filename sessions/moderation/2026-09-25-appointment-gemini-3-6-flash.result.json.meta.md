---
title: 'Evidence: 2026-09-25-appointment-gemini-3-6-flash.result.json'
date: '2026-09-25'
...
source_sha256: 87960d04d22aa10b1df84a5c150813a81947574e13138b43157444ebda748df7
output_sha256: b5f04a140a11534d9f917037d719aad5b1d14a60b4fbe0b4d881099a8d2b326e
redactions:
  account-id: 1
withheld:
  B, thinking: 1
...
Exported payload `sessions/moderation/2026-09-25-appointment-gemini-3-6-flash.result.json`. Redactions are marked `[REDACTED: <category>]` and withheld parts `[WITHHELD: <class or category>; see manifest]`. See `sessions/manifest.md`.
