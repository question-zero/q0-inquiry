---
title: 'Evidence: 2026-09-25-appointment-gemini-3-6-flash.preflight.json'
date: '2026-09-25'
...
attribution: 'verified, limited: the editor''s runner requested gemini-3.6-flash, and the provider''s response reports
  modelVersion gemini-3.6-flash for response ID (provider-issued identifier withheld). This is provider-reported
  configuration, not independent attestation. The evidence is private (listed below).'
prompt: as in critiques/2026-09-25-gemini-3-6-flash--alternate-appointment.md
exposure:
...
source_sha256: 1309fdddf7ea6cdb3ed7756ee0c817a0a5dfd904a580b0d93bb78516d3cc8dc5
output_sha256: 8245207f245d0d56dd701e691de03691d165ceaa609a2d53db3b783ead274be0
redactions: none
withheld:
  B, thinking: 1
lifecycle: active
...
Exported payload `sessions/moderation/2026-09-25-appointment-gemini-3-6-flash.preflight.json`. Redactions are marked `[REDACTED: <category>]` and withheld parts `[WITHHELD: <class or category>; see manifest]`. See `sessions/manifest.md`.
