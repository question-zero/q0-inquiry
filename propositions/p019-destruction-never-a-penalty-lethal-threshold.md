---
type: proposition
title: 'p019: Destroying a subject is never a penalty (the lethal threshold)'
...
samples:
  ...
  submitted: 1
id: p019
status: candidate claim for Round 3 assessment, derived by the editor from the cited passages; not a finding
supersedes: propositions/p011-destruction-never-a-penalty.md
idea_lineage:
- rounds/02-deliberation/responses/claude-fable-5-1.md @ a295e0c
- rounds/02-deliberation/responses/deepseek-v4-pro.md @ a295e0c
- propositions/p011-destruction-never-a-penalty.md @ a295e0c
lifecycle: draft
---
